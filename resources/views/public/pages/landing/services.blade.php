@php
    $heroServices = [
        [
            'title' => 'New Build',
            'details' =>
                'At Bangla Construction Limited., our New Build service encompasses the creation of stunning, custom-built structures from the ground up. From conceptualization to completion, we handle every aspect of the construction process with precision and expertise. Our team works closely with clients to bring their visions to life, ensuring superior quality and attention to detail in every new build project we undertake.',
            'image' => 'frontend/image/services/New-Build.webp',
        ],
        [
            'title' => 'Foundations',
            'details' =>
            ...
            'image' => 'frontend/image/services/Foundations.webp',
        ],
        [
            'title' => 'Footing',
            'details' =>
            ...
            'image' => 'frontend/image/services/Footing.webp',
        ],
        [
            'title' => 'Earthmoving',
            'details' =>
                'At Bangla Construction Limited, our earthmoving service is essential for preparing sites and shaping landscapes with precision. Using advanced equipment and skilled operators, we handle earthmoving tasks efficiently and safely. From site clearing to excavation, our earthmoving services are integral to construction and renovation projects, ensuring the groundwork is laid for successful outcomes. Trust us for reliable earthmoving solutions tailored to your needs.',
            'image' => 'frontend/image/services/Earthmoving.webp',
        ],
        [
            'title' => 'Demolition',
            'details' =>
                "Bangla Construction Limited. offers professional demolition services tailored to meet the needs of your construction or renovation project. With safety and efficiency as our top priorities, our skilled team utilises advanced equipment and techniques to dismantle structures safely and effectively. Whether it's a small-scale demolition or a larger project, trust us to handle the job with precision and care, leaving your site ready for the next phase.",
            'image' => 'frontend/image/services/Demolition.webp',
        ],
        [
            'title' => 'Renovation',
            'details' =>
                "Bangla Construction Limited. specialises in transformative renovation services that breathe new life into existing spaces. With meticulous attention to detail and craftsmanship, our expert team revitalises interiors and exteriors, enhancing functionality, aesthetics, and value. Whether it's a residential or commercial property, our renovation services are tailored to meet your unique needs and exceed your expectations, turning your vision into reality with precision and care.",
            'image' => 'frontend/image/services/Renovation.webp',
        ],
        [
            'title' => 'Maintenance',
            'details' =>
