                ...
                <form method="post" action="{{ route('admin.brand.update', $brand->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="p-sm-3">
                        ...
                        <div class="form-group row @error('name') error @enderror">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="name"
                                    value="{{ old('name', $brand->name) }}" placeholder="{{ __('Write Testimonial Name') }}"
                                    required>
                                @error('name')
                        ...
                        <div class="form-group row @error('avatar') error @enderror">
                            ...
                            <div class="col-sm-9">
                                <div class="file-upload-section">
                                    ...
                                    <div class="display-input-image @if ($brand->avatar == null) d-none @endif">
                                        <img src="{{ $brand->getAvatar() }}" alt="Avatar" />
                        ...
                        <div class="form-group row @error('message') error @enderror">
                            ...
                            <div class="col-sm-9">
                                <textarea type="text" name="message" class="form-control" placeholder="{{ __('Write Description') }}"
                                    rows="4">{{ old('message', $brand->message) }}</textarea>
                                @error('message')
                                    <p class="error-message">{{ $message }}</p>
                                @enderror
                            </div>
