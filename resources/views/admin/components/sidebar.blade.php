...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        @if ($user_role->hasPermission('notification_index') && false)
            <li class="nav-item">
        ...
        @if ($user_role->hasPermission('menu_manage_people'))
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#managePeople" aria-expanded="false"
                ...
                <div class="collapse" id="managePeople">
                    <ul class="nav flex-column sub-menu">
                        ...
                        @if ($user_role->hasPermission('client_index'))
                            <li class="nav-item">
                                <a class="nav-link"
                                    href="{{ route('admin.client.index', ['type' => \App\Library\Enum::CLIENT_TYPE_CLIENT]) }}">
                                    Client
                                </a>
                            </li>
                        @endif
                        ...
                        @if ($user_role->hasPermission('partner_index'))
                            <li class="nav-item">
                                <a class="nav-link"
                                    href="{{ route('admin.partner.index', ['type' => \App\Library\Enum::CLIENT_TYPE_PARTNER]) }}">
                                    Partner
                                </a>
                            </li>
                        @endif
        ...
        @if ($user_role->hasPermission('menu_asset'))
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#asset" aria-expanded="false"
                    aria-controls="tables">
        ...
        @if (false)
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#analyticssss" aria-expanded="false"
                    aria-controls="tables">
                ...
                <div class="collapse" id="analyticssss">
                    <ul class="nav flex-column sub-menu">
                        ...
                        @if ($user_role->hasPermission('report_transactions'))
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.report.transaction') }}"> Transaction
                                    Report </a>
                            </li>
                        @endif
                        ...
                        @if ($user_role->hasPermission('report_member_status'))
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.report.memberStatus') }}"> Member Status
                                </a>
                            </li>
                        @endif
                        ...
                        @if ($user_role->hasPermission('report_member_signup'))
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.report.memberSignup') }}"> Member Signup
                                </a>
                            </li>
                        @endif
                ...
                <div class="collapse" id="settings">
                    <ul class="nav flex-column sub-menu">
                        ...
                        @if ($user_role->hasPermission('dropdown_index'))
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.config.dropdown.list') }}"> Dropdown
                                    List</a>
                            </li>
                        @endif
                        ...
                        @if ($user_role->hasPermission('setting_email'))
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.config.email.index') }}"> Email Templates
                                </a>
                            </li>
                        @endif
                        ...
                        @if ($user_role->hasPermission('general_settings_show'))
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.config.general.settings') }}"> General
                                    Settings </a>
                            </li>
                        @endif
                    </ul>
