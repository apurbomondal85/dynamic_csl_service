...
class HomeController extends Controller
{
    public function dashboard()
    {
        ...
        $career = Career::where('is_active', 1)->where('deadline', '>', today())->count();
        ...
        return view('admin.pages.home.dashboard', compact('newMember', 'inactiveMember', 'activeMember', 'career', 'blog', 'event', 'users', 'newUsers', 'monthlySignup'));
    }
}
